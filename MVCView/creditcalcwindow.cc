...
void CreditCalcWindow::on_pushButton_calculate_clicked() {
  ...
  //    ui->statusBar->showMessage("Total credit amount: minimum value is
  //    0.01");
  //  } else if (data.term < 1) {
...
//   QString month_payment = QString::number(result->first_month_payment, 'f',
//   2); if (ui->radioButton_differentiated->isChecked()) {
//     month_payment +=
